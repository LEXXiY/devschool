<?php /* Smarty version 2.6.25-dev, created on 2016-04-06 06:27:31
...
<form style="margin-left: 30%;" method="post"> <font size="4">
    ...
    <div> 
        ...
        <input type="text" maxlength="40" value="<?php echo $this->_tpl_vars['display']->getSellerName(); ?>
...
" name="email" id="fld_email">
    ...
    <div>
        <label for="allow_mail"> <input type="checkbox" value=1 <?php if (( $this->_tpl_vars['display']->getAllowMail() == 1 )): ?>checked<?php endif; ?> name="allow_mail" id="allow_mail">
...
" name="phone" id="fld_phone">
    ...
    <div class="form-group">
        ...
        <?php echo smarty_function_html_options(array('name' => 'city_id','options' => $this->_tpl_vars['cities'],'selected' => $this->_tpl_vars['display']->getCityId()), $this);?>

    </div>
    <div class="form-group">
        <label for="fld_category_id" class="form-label">Категория</label> 
        <?php echo smarty_function_html_options(array('name' => 'category_id','options' => $this->_tpl_vars['categories'],'selected' => $this->_tpl_vars['display']->getCategoryId()), $this);?>
