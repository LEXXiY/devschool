...
<form style="margin-left: 30%;" method="post"> <font size="4">
    ...
    <div> 
        ...
        <input type="text" maxlength="40" value="{$display->getSellerName()}" name="seller_name" id="fld_seller_name">
    </div>
    <div>
    ...
    <div>
        <label for="allow_mail"> <input type="checkbox" value=1 {if ($display->getAllowMail() eq 1)}checked{/if} name="allow_mail" id="allow_mail">
    ...
    <div class="form-group">
        ...
        {html_options name=city_id options=$cities selected=$display->getCityId()}
    </div>
    <div class="form-group">
        <label for="fld_category_id" class="form-label">Категория</label> 
        {html_options name=category_id options=$categories selected=$display->getCategoryId()}
    </div> 
    <div id="f_title">
